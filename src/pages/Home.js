...
const Home = () => {
    return(
        <div>
            ...
            <div class="w3-display-container w3-grayscale-min w3-hide-medium w3-hide-large" style={{margin:"auto"}}>
                <img class="imgDimmerSmall" src={homeImg1} alt="HVAC and Home Renovations Specialist"></img>
                <div class="w3-display-left w3-text-white w3-center" style={{padding:"10px", position:"absolute", top:"300px"}}>
